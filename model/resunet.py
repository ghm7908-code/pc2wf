...
from model.me_compat import coordinate_manager, coordinate_map_key, sparse_tensor
  ...
  def forward(self, x):
    ...
    if self.normalize_feature:
      return sparse_tensor(
          ...
          coordinate_map_key=coordinate_map_key(out),
          coordinate_manager=coordinate_manager(out))
    else:
      return out
